...
include get_parent_theme_file_path('inc/setup.php');
...
include get_parent_theme_file_path('inc/icons.php');
include get_parent_theme_file_path('inc/menu-item-text-to-icon.php');
